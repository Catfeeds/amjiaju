  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    <tr class="head">
      ...
      <td><div class="nav"> 
        ...
        <div class="login_info"><span class="mr10"><?php echo ($role_name); ?>： <?php echo ($userInfo["username"]); ?></span><a href="<?php echo U('Public/logout');?>" class="mr10">[注销]</a><?php echo tag("view_admin_top_menu");?><a href="<?php echo ($Config["siteurl"]); ?>" class="home" target="_blank">前台首页</a><a href="<?php echo ($Config["addonsite"]); ?>" class="home" target="_blank">开放平台</a><?php if(\Libs\System\RBAC::authenticate('Admin/Index/cache')){ ?><a href="javascript:;;" id="deletecache" class="home"  style="color:#FFF">缓存更新</a><?php } ?></div></td>
    </tr>
    <tr class="tab">
      <th> <div class="search">
