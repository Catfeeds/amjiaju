...
<div class="head clear">
    ...
    <div class="head_zw">
        <div class="head_bottom">
            <div class="head_logo fl"><a href="/"><img src="{$Config.sitepclogo}" /></a></div>
...
<if condition="$catid eq 0">
    <div class="banner">
        ...
        <div class="banner_no">
            <div class="banner_bo">
                <content action="lists" catid="77" order="listorder">
                    <volist name="data" id="vo">
                        <div style="background: url('{$vo.thumb}') center no-repeat;" class="banner_2 fl"> <a href="" title=""></a> </div>
                    </volist>
                </content>
            </div>
        </div>
    ...
    <else/>
    <div class="lxye_banner" style="background:url({:getcategory($catid,'image')}) no-repeat center;"></div>
</if>
