    ...
    <form method='post'   id="myform" class="J_ajaxForm"  action="{:U('Config/index')}">
      ...
      <tr>
	     ...
	     <td><textarea name="siteinfo" style="width:380px; height:150px;">{$Site.siteinfo}</textarea> </td>
          ...
          <tr>
              <th>电脑端logo：</th>
              <td><Form function="images" parameter="sitepclogo,sitepclogo,$Site['sitepclogo'],content"/><span class="gray"> 双击可以查看图片！</span></td>
          </tr>
          <tr>
              <th>手机端logo：</th>
              <td><Form function="images" parameter="sitewaplogo,sitewaplogo,$Site['sitewaplogo'],content"/><span class="gray"> 双击可以查看图片！</span></td>
          </tr>
      <tr>
